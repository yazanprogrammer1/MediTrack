package com.example.meditrack.feature.presentation.util
...
data class ScreensDimens(
    ...
    val instructionScreenSwipeDeleteGifDimen: Dp = 200.dp,
)
...
val CompactSmallDimens = ScreensDimens(
    appDrawerDimens = AppDrawerDimens(
        ...
        spacerBetweenLanguageSelectorAndItemsOnTop = 8.dp,
...
val MediumDimens = ScreensDimens(
    ...
    instructionScreenSwipeDeleteGifDimen = 400.dp
)
